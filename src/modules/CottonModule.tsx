          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                title="Print Cotton Stock Report"
              >
                <Printer className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" /> Print Stock
              </button>
              <button
              ...
              <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    title="Print Daily Cotton Report"
                  >
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 space-y-4">
              <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <button
                  onClick={() => triggerAppPrint()}
                  className="no-print px-3 py-2 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 font-bold rounded-xl text-xs flex items-center gap-1 transition"
                  title="Print Monthly Cotton Report"
                >
                  <Printer className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" /> Print Report
                </button>
              </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  title="Print Report"
                >
                  <Printer className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" /> Print
                </button>
                <button
                  onClick={() => {
